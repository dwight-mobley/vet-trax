    ...
    return (
        <div className="max-w-3xl mx-auto p-6 md:p-12">
            ...
            <div className="bg-background-paper border border-text-disabled rounded-large shadow-sm overflow-hidden">
                ...
                {/* Hero / Image Section */}
                <div className="h-64 bg-background w-full object-cover relative border-b border-text-disabled">
                    {pet.image ? (
                ...
                <div className="p-6 md:p-8 flex justify-between items-start border-b border-text-disabled">
                    <div>
                        <h1 className="text-4xl font-bold text-text-primary capitalize mb-2">
                            {pet.name}
                        </h1>
                        <span className="bg-secondary text-secondary-contrast text-sm font-semibold px-3 py-1 rounded-medium capitalize inline-block">
                            {pet.type}
                        </span>
                    </div>
                ...
                <div className="p-6 md:p-8 bg-background border-t border-text-disabled">
                    ...
                    {pet.notes ? (
                        <div className="bg-background-paper p-4 rounded-medium border border-text-disabled text-text-primary italic">
                            {pet.notes}
                        </div>
                    ) : (
                        <p className="text-text-disabled italic">No notes added for this pet.</p>
                    )}
                </div>
